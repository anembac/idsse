 ...
 * @ingroup cam
 */
class EtsiCaBasicService : public CaBasicService,
...
public:
    ...
    */
    ...
    //! Last heading value
    boost::optional<double> getlastHeading() override;

    //! Last position data
    boost::optional<Wgs84Position> getlastPosition() override;

    //! Last speed value
    boost::optional<double> getlastSpeed() override;


    std::chrono::milliseconds getTimeSinceLastCam() override;
